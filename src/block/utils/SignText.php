...
class SignText{
	 ...
	 */
	public function __construct(?array $lines = null, ?Color $baseColor = null, bool $glowingText = false){
	 ...
	 */
	public static function fromBlob(string $blob, ?Color $baseColor = null, bool $glowingText = false) : SignText{
		return new self(array_slice(array_pad(explode("\n", $blob), self::LINE_COUNT, ""), 0, self::LINE_COUNT), $baseColor, $glowingText);
	}
	 ...
	 */
	public function isGlowingText() : bool{
